...
export type GuardrailType = 'manual' | 'statistical';

interface GuardrailsControlsProps {
  testType: TestType;
  baselineMean: number;
  ...
  onGuardrailTypeChange: (value: GuardrailType) => void;
  onManualGuardrailChange: (value: number) => void;
  onStatisticalConfidenceChange: (value: number) => void;
...
export function GuardrailsControls({
  ...
  onManualGuardrailChange,
  onStatisticalConfidenceChange,
  onPeekingModeChange,
  onPeekingFrequencyChange,
  onTestDurationChange,
  onRunSimulation,
  isRunning,
}: GuardrailsControlsProps) {
  ...
  return (
    <div className="bg-gray-800 rounded-lg shadow-md border border-gray-700 p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
        ...
        <div className="md:col-span-2 bg-orange-50 border border-orange-200 rounded-md p-4">
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-orange-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-transparent mb-3"
          >
          ...
          {guardrailType === 'manual' ? (
            <div>
              ...
              />
              <p className="text-xs text-orange-700 mt-1">Static threshold (e.g., -5% to stop test if it drops below)</p>
            </div>
          ) : (
            <div>
              <label className="block text-sm font-medium text-orange-900 mb-2">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-orange-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-transparent"
              />
              <p className="text-xs text-orange-700 mt-1">Two-sided CI: 99% is more conservative than 95%</p>
            </div>
          )}
        </div>
        ...
        <div className="md:col-span-2">
          ...
          <select
            ...
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-orange-500 focus:border-transparent mb-3"
          >
