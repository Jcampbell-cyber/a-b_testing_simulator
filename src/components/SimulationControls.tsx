...
interface SimulationControlsProps {
  ...
  onLowerCIChange: (value: number) => void;
  onUpperCIChange: (value: number) => void;
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div>
          ...
          <input
            ...
            step="0.1"
            value={lowerCI}
            onChange={(e) => onLowerCIChange(Number(e.target.value))}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
          <p className="text-xs text-gray-500 mt-1">Negative threshold (e.g., -99.9 for -99.9%)</p>
        </div>
        ...
        <div>
          ...
          <input
            ...
            step="0.1"
            value={upperCI}
            onChange={(e) => onUpperCIChange(Number(e.target.value))}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          />
          <p className="text-xs text-gray-500 mt-1">Positive threshold (e.g., 95.5 for +95.5%)</p>
        </div>
