...
export function SampleSizeCalculator({ onBack }: SampleSizeCalculatorProps) {
  ...
  const calculateSampleSize = () => {
    ...
    return { samplesPerGroup, totalSamples };
  };
        ...
        <div className="bg-gray-800 rounded-lg shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="space-y-6">
                ...
                <div className="space-y-2">
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4"
                    />
                    <span className="text-gray-300">Continuous (e.g., revenue, time)</span>
                  </label>
                  <label className="flex items-center gap-3 cursor-pointer">
                    <input
                      type="radio"
                      ...
                      className="w-4 h-4"
                    />
                    <span className="text-gray-300">Binary (e.g., click, conversion)</span>
                  </label>
                </div>
              </div>
              ...
              <div>
                <label className="block text-white font-semibold mb-3">
                  Minimum Detectable Effect Size (MDE): {effectSize.toFixed(3)}
                </label>
                <input
                  type="range"
                  min="0.01"
